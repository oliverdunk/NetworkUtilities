...
public class LocationSerialization {
    ...
    /**
     * Serializes the Location and returns the
     * String form.
     * 
    ...
    /**
     * Gets Location from the a JSONObject constructed from the given
     * String
     * 
     * @param json The String to use
     * @return Location taken from a JSONObject constructed from the
     *         given String
     */
