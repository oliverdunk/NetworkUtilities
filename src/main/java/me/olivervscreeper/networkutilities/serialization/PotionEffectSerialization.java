...
/**
 * A class to help with the serialization of PotionEffects. The serialization technique is similar
 * to that of serializing enchantments. The process can be as explained as such: <br/> <br/>
 *
 * <pre>
 * String serializedEffects = &quot;&quot;;
 * for (PotionEffect e : effects) {
 *     serializedEffects += e.getType().getId() + &quot;:&quot; + e.getDuration() + &quot;:&quot; +
 * e.getAmplifier() + &quot;;&quot;;
 * }
 * </pre>
 *
 * <br/> So that it would follow this pattern:<br/>
 *
 * <pre>
        ...
        for (int i = 0; i < effs.length; i++) {
            ...
            if (effect.length < 3) {
                throw new IllegalArgumentException(
                        serializedEffects + " - PotionEffect " + i + " (" + effs[i]
