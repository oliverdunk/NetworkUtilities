...
/**
 * A class to help with the serialization of Wolves. <br/> <br/> This serialization class supports
...
public class WolfSerialization {
  ...
  public static Wolf spawnWolf(Location location, JSONObject stats) {
    try {
      ...
      wolf.setCollarColor(
          DyeColor.getByColor(ColorSerialization.getColor(stats.getString("collar-color"))));
      return wolf;
    } catch (JSONException e) {
      e.printStackTrace();
      return null;
