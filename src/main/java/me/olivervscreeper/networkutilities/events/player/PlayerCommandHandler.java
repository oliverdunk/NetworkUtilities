...
public class PlayerCommandHandler implements Listener{
     ...
     */
    public PlayerCommandHandler(PermissionSet permission){this.permission = permission;}
    public PlayerCommandHandler(PermissionSet permission, EventPriority eventPriority){this.permission = permission; this.eventPriority = eventPriority;}
