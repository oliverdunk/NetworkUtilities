...
public class DataUtils {
    ...
    public static <T extends Object> void saveObjectToPath(T objectToSave, String pathToSaveTo) {
        try {
            ...
            NetworkUtilities.log("Attempted to save file to " + pathToSaveTo + " - sadly, an error occurred.");
        }
    }
    ...
    public static <T extends Object> T loadObjectFromPath(String pathToLoadFrom) {
        try {
            ...
            NetworkUtilities.log("Attempted to load file from " + pathToLoadFrom + " - sadly, an error occurred.");
            return null;
        }
    }
