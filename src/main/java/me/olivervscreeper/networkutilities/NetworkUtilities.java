...
public class NetworkUtilities extends JavaPlugin {
    ...
    public static final String version = "1.4.5-RELEASE";
    public static final String compatibility = "Spigot 1.8.8-R0.1-SNAPSHOT";

    public static Plugin plugin;

    /**
     * The default CommandManager which is created and used by the
    ...
    /**
     * Default Bukkit onEnable() method. Triggers the plugin launch one the Bukkit wrapper has
     * loaded and is ready to begin the handling of plugins.
     */
    ...
    /**
     * Sets up the mcStats metrics system.
     */
    ...
    /**
     * A command for checking the network utilities version in use.
     */
    ...
    /**
     * A command for creating and sending a HasteBin link to the player of the current NULogger contents.
     */
    ...
    /**
     * Compiles and runs the player given HasteBin link containing Java code.
     */
